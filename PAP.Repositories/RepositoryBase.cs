...
public interface IRepositoryBase<T>
{
	...
	/// <summary>
	/// Finds a entity from the list of objects
	/// </summary>
	/// <param name="id">Integerr</param>
...
{
	private readonly AspnetPapMvc758776242b5d4de4Af1d754cadeb9234Context _context;
	protected AspnetPapMvc758776242b5d4de4Af1d754cadeb9234Context DbContext => _context;
	...
	{
		_context = new AspnetPapMvc758776242b5d4de4Af1d754cadeb9234Context();
	}
